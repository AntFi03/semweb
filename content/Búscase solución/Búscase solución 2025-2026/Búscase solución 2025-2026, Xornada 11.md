---
title: Búscase solución 2025-2026, xornada 11
description:
comments: true
draft: false
enableToc: true
...
Para enviar os problemas, facédelo dende o correo que puxéchedes á hora de inscribirvos ao [correo (mestrecazador@gmail.com)](mailto::mestrecazador@gmail.com) poñendo como asunto "Xornada11.ProblemaX.NivelX". Un correo por problema.
...
> Resolve $$\frac{1}{m}+\frac{1}{n}=\frac{1}{p}$$ con $m,n\in\mathbb{Z}^+,m\neq n$, e $p$ primo.
...
> Consideremos o anel $A=\mathbb{Z}\left[\sqrt{-17}\right]$ e os números primos $p_1=2, p_2=3$ e $p_3=5$. 
> 
> Como factoriza o ideal $\left(p_i\right)$ en $A$?
>	
> E para $p\in\{2003,2011,2017,2027,2029\}$?

>[!solution5]- Nivel 3, Problema 2
> Dado $A\subset\mathbb{R}^n$, definimos $c(A)$ como os puntos de $A$ tales que $A$ é estrelado respecto a ese punto. É $c(A)$ estrelado? É $c(A)$ convexo? 

>[!solution5]- Nivel 3, Problema 3
> ![[BS_2526_X11_33.png]]
> 
