...
> [!solution2]- Solución
> Sexa $q=1-p$, e $D_1, D_2, D_3$ as tres decisións dos xuíces (o do "cara ou cruz" será o terceiro). 
> Cada $D_i$ será ou un E (éxito) ou F (fracaso), polo que a decisión será correcta se e só se 
