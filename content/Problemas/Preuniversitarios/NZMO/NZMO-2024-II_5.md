...
> - Supoñemos que $\exists L'<3$ que funciona e collemos $a,b,c,d$ tal que sexan grandes enteiros consecutivos. Se $L'=3- \epsilon, \epsilon>0$, e así $\exists n \in \mathbb{Z}$ tal que $n>\frac{3}{\epsilon}$. Isto asegura que $\frac{1}{n+1}, \frac{1}{n+2} \text{ e } \frac{1}{n+3}$ son máis pequenos que $\frac{\epsilon}{3}$. Agora consideremos $(a,b,c,d)=(n,n+1,n+2,n+3)$.
