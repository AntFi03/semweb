...
> - c) Para este apartado temos que ter en conta que no suceso _sacar un as e dúas figuras_ non está establecida a orde, polo que os casos favorábeis serán tres: sacar o as de primeiro, de segundo e de terceiro. É dicir, os casos favorábeis serán $\{(A,F,F), (F,A,F), (F,F,A)\},$  sendo $F$ sacar unha figura e $A$ sacar un as. Así, $$\mathbb{P}[\text{"un as e dúas figuras"}] = \mathbb{P}[(A,F,F)] + \mathbb{P}[(F,A,F)] + \mathbb{P}[(F,F,A)]=$$
> - $$=\frac{1}{10} \cdot \frac{3}{10} \cdot \frac{3}{10} + \frac{1}{10} \cdot \frac{3}{10} \cdot \frac{3}{10} + \frac{1}{10} \cdot \frac{3}{10} \cdot \frac{3}{10} = \frac{27}{1000}.$$
